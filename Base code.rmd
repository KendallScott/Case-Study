...
#ABV distribution by bottle ounces
...
library(gifski)
usa <- map_data("state")
#bubble graph using map and simplified beer styles
p <- ggplot() +
...
#boxplots by Style
library(viridis)
ggplot(brewcomb_type, aes(x = BeerStyle, y = IBU, fill = BeerStyle)) +
  geom_boxplot() +
  theme_classic()+
  scale_fill_viridis(option="magma", discrete=TRUE, name="Beer Style" )
